...
class EuropythonSpider(CrawlSpider):
	...
	allowed_domains = ["ep2015.europython.eu","ep2016.europython.eu", "ep2017.europython.eu","ep2018.europython.eu","ep2019.europython.eu","ep2020.europython.eu","ep2021.europython.eu"]
	...
	Rule(LxmlLinkExtractor(allow=['talks']),callback='process_response_europython2019_2020_2021')]
	...
	def process_response_europython2019_2020_2021(self, response):
		item = EuropythonItem()
